...
{
    public  class OkumaMill : IOkumaMill
    {
        ...
        public void SetUserAlarmWithHelp(AlarmLevelEnum AlarmLevel, string ShortMessage, string HelpMessage)
        {
            ...
            //https://stackoverflow.com/questions/1818131/convert-an-enum-to-another-type-of-enum
            global::Okuma.CLCMDAPI.Enumerations.UserAlarmEnum _level = (global::Okuma.CLCMDAPI.Enumerations.UserAlarmEnum)Enum.Parse(typeof(global::Okuma.CLCMDAPI.Enumerations.UserAlarmEnum), AlarmLevel.ToString());
