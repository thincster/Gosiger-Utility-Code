...
namespace Okuma_Monitor_Tools.Okuma.IOkumaAPI
{
    ...
    // Used to convert our local Eums to the machine specific Enumerations.

    public class OkumaLatheGeneric : IOkuma
    {
        ...
        /// <returns>Value of Common Variable</returns>
        ...
        /// <summary>
        /// Do Not Use this method, this is for a Mill.
        /// Use GetAddressByLabel_Lathe.
        /// </summary>
